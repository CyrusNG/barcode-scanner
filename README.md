...
All releases of this package can be found on [npm](https://www.npmjs.com/package/@capacitor-plugin-qr-barcode-scanner?activeTab=versions) and on [GitHub Releases](https://github.com/CyrusNG/capacitor-plugin-qr-barcode-scanner/releases)

## Installation

```bash
npm install @capacitor-plugin-qr-barcode-scanner
npx cap sync
```
...
```ts
import { BarcodeScanner, SupportedFormat } from '@capacitor-plugin-qr-barcode-scanner';
...
please [open an issue](https://github.com/CyrusNG/capacitor-plugin-qr-barcode-scanner/issues/new/choose)
